...
Use the shared Codex skills installed from this skills repository.
...
- `AGENTS.md`: durable Codex rules for this repository.
...
Do not put live task state in `AGENTS.md`, `PROJECT.md`, `CONTEXT.md`, or ADRs. Keep temporary run state under `.agent-runs/` when a high-context skill needs persistence.
